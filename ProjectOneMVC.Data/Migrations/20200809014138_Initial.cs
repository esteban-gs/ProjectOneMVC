    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SchoolUserId = table.Column<string>(nullable: false),
                    ClassId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserClasses", x => new { x.ClassId, x.SchoolUserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserClasses_AspNetUsers_SchoolUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserClasses_SchoolUserId",
                table: "UserClasses",
                column: "SchoolUserId");
        }
